namespace SmartLin.LearningCSharp.GenericTypeAndCollection
{
    class Program
    {
        static void Main()
        {
            ...
            SurveyQuestion<string> multiChoiceQuestion2 = new SurveyQuestion<string>();
            multiChoiceQuestion2.Question = "你觉得最大的学习困难是什么？A、缺乏抽象思维 B、编程基础薄弱 C、缺少学习氛围 D、缺少实践机会";
            multiChoiceQuestion2.Answer = "AC";
