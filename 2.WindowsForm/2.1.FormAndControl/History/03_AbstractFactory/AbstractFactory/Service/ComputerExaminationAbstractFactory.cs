...
namespace SmartLin.LearningCSharp.FactoryPattern
{
    ...
    public class ComputerExaminationAbstractFactory : IExaminationAbstractFactory
    {
        ...
        {
            IExamination computerExamination = null;
            Console.WriteLine("《{0}》上机考试安排申报：", courseName);
            IExaminationRoom laboratory = this.CreateExaminationRoom();
            IInvigilator laboratoryStaff = this.CreateInvigilator();
            if (laboratory == null)
            {
                return null;
            }
            ...
            computerExamination = new ComputerExamination()
            {
                CourseName = courseName,
                Room = laboratory,
                Invigilator = laboratoryStaff
            };
            return computerExamination;
        }
    }
}
