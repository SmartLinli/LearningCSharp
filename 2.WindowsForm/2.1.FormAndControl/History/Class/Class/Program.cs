...
namespace SmartLin.LearningCSharp.Oop
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            LearningTask
                oopLearningTask = new LearningTask("18-19-2_238", mrLin, oop, LearningStatus.Normal, rateClosingDate)
                , networkLearningTask = new LearningTask("18-19-2_241", mrChen, network, LearningStatus.Normal, rateClosingDate)
                , cProgrammingLearningTask = new LearningTask("18-19-2_238_b", msZhang, cProgramming, LearningStatus.Retaking, rateClosingDate);
